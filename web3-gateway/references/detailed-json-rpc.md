...
Find a [brief list of supported calls](brief-json-rpc.md).
{% endhint %}
...
[Brief version](./brief-json-rpc.md#eth_getBlockByHash)
...
[Brief version](./brief-json-rpc.md#eth_getBlockByNumber)
...
```json
{
  ...
  "result": {
    "number": "0x78497f",
    "hash": "0x5e90342dd3068502937f00b6a167dfcd972cb10fe8baef71dadc7c003c5cbfd6",
    "parentHash": "0x0c9773247f923b16c93934650d117c4d4741211613d30ea58961701877f2c0ee",
    "nonce": "0x0000000000000000",
    "mixHash": "0x5669ce0681a0b0951a42603fe8251264d54aa3a6cb5b868bf0300da874f895c0",
    "sha3Uncles": "0x1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347",
    "logsBloom": "",
    "stateRoot": "0x4ce212a179bcd81c39d1983844f77b83048d27896121bae10fdae5afa4e8c163",
    ...
    "gasLimit": "0x1c9c380",
    "gasUsed": "0x2787e1",
    "timestamp": "0x636377dc",
    "transactionsRoot": "0x345ce8dc9972560ed2465440b6825239d426854460923e37194dc86fc12303ce",
    "receiptsRoot": "0xeac9269a08fb18242e4fae66430944449c98cf1b1884252720482ec99872064f",
    "baseFeePerGas": "0x303c9facb",
    "totalDifficulty": "0xa4a470",
    "uncles": [],
    "transactions": [
      "0x234d2931a12a4790889346800a59afdb190bab983d6c17d314feca22414adf97",
      "0xdaed43a62f763553a2c552a3749da4477414a6469185b5f4e8d8e76e800a00bd",
      "0x7c69ec5015370361f9b3659d5fc6c921e4a27720d885aa08d87828bc4df33850",
      "0xf5458c65f1b9add96ccfb5fb2074fa82716a7cc27b431baaa9f37667c58dc2ef",
      "0x4d5345a37e21030d6cab142e2b3eadcf15b1b3094f6ae440257a4dcc8fcaff7a",
      "0x1f624e35c71f9530aacdf77ce0e7497e43a8c0ddda6f63c4a78a73200dab1ef7",
      "0x70a63130271323742ab1645ead14dddce0bc81165b2631e365adbcac447851c7",
      "0x9b38cd09f42a2735b90c26e39707442cc3d888710f835612e3d99336f03fa2bb",
      "0x5184d8115db9fddbd60a530349d2203fa72379a74daf93371494b6d918936ddc",
      "0x6b0ef30f7558a263805ae2fcd6e625abc30c7adc62fac7dd67f51c771e17ec06",
      "0xf3d233d6667aa5ad0a1356f9a91087cdc57759e3f03d9c423b52b6b918226b79",
      "0x79d1406a626509d412e58c0438f3ba10918e6417f38cc027b82bbcc7547d6fd5",
      "0xf7e4e5d926b0af3adbea7548425f19b288437a68f085e3af263f1cfe1b2066ed",
      "0x42a479f2e0a03d352cfd8edf5823e907b931e8462ce15d821d39fb5ef24d4be2",
      "0x33dfea9525ccdcd3a7795afd6796741ca33ab256bf9f6c83447164649934e1f2",
      "0x2b3900ac368863553517a6bd4118aee9d1bb728cdcbce667c9b24c2b9d738ab5",
      "0x3a500a77248532cad2171e24c05be072c82d2494d7ee70945f236bc883dcb3d9",
      "0x3db5e63dd70d9e8896890659a3f967f70940d751d2e3316dda4f2567d422c5ed"
    ]
  }
}
```
...
[Brief version](./brief-json-rpc.md#eth_getBlockTransactionCountByHash)
...
[Brief version](./brief-json-rpc.md#eth_getBlockTransactionCountByNumber)
...
[Brief version](./brief-json-rpc.md#eth_getUncleCountByBlockHash)
...
[Brief version](./brief-json-rpc.md#eth_getUncleCountByBlockNumber)
...
[Brief version](./brief-json-rpc.md#eth_chainId)
...
[Brief version](./brief-json-rpc.md#eth_syncing)
...
[Brief version](./brief-json-rpc.md#eth_accounts)
...
[Brief version](./brief-json-rpc.md#eth_blockNumber)
...
[Brief version](./brief-json-rpc.md#eth_call)
...
[Brief version](./brief-json-rpc.md#eth_estimateGas)
...
[Brief version](./brief-json-rpc.md#eth_gasPrice)
...
[Brief version](./brief-json-rpc.md#eth_maxPriorityFeePerGas)
...
[Brief version](./brief-json-rpc.md#eth_feeHistory)
...
[Brief version](./brief-json-rpc.md#eth_newFilter)
...
1. **Filter** (*optional*) filter `OBJECT`
  ...
  - **address** (*optional*) `ONEOF` of Address(es) 
    ...
    - `ARRAY` of `STRING` hex encoded address
  - **topics** (*optional*)  Topics `ARRAY` of 
    - `NULL`
...
```json
{
  "id": 0,
  "jsonrpc": "2.0",
  "result": "0x5621eef755d68ff4fea81a9f0ca4128bddbe9d777a90c5c916d87c1f3a879a1c"
}
```
{% endtab %}
...
[Brief version](./brief-json-rpc.md#eth_newBlockFilter)
...
```json
{
  "id": 0,
  "jsonrpc": "2.0",
  "result": "0xc52eb9c1edf83133a0485c1e1c55ba8b9693a3953c661c34e28cacf0505d92de"
}
```
{% endtab %}
...
[Brief version](./brief-json-rpc.md#eth_mining)
...
[Brief version](./brief-json-rpc.md#eth_hashrate)
...
[Brief version](./brief-json-rpc.md#eth_getBalance)
...
[Brief version](./brief-json-rpc.md#eth_getStorageAt)
...
[Brief version](./brief-json-rpc.md#eth_getTransactionCount)
...
[Brief version](./brief-json-rpc.md#eth_getCode)
...
[Brief version](./brief-json-rpc.md#eth_sendTransaction)
...
[Brief version](./brief-json-rpc.md#eth_sendRawTransaction)
...
[Brief version](./brief-json-rpc.md#eth_getTransactionByHash)
...
[Brief version](./brief-json-rpc.md#eth_getTransactionByBlockHashAndIndex)
...
[Brief version](./brief-json-rpc.md#eth_getTransactionByBlockNumberAndIndex)
...
[Brief version](./brief-json-rpc.md#eth_getTransactionReceipt)
