...
{% hint style="success" %}
Note - since the addition of [**Wallet **](../../../monitoring/wallets/)support to Tenderly, we now have a new parameter when adding alert targets which are _addresses_ instead of previously _contracts_.
{% endhint %}
